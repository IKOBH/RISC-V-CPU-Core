...
\SV
   ...
   //m4_asm(ADDI, x0, x0, 0000000000001) // Try adding 1 to register x0.
...
\TLV
   ...
   //ALU: SRA and SRAI (shift right, arithmetic) results:
   //  sign-extended src1
   ...
   $result[31:0] =
     ...
     $is_slli ? $src1_value << $imm[5:0]: //Shouldnt it be $imm[4:0]?:
     $is_srli ? $src1_value >> $imm[5:0]: //Shouldnt it be $imm[4:0]?:
